<template>
	<div id="app">
		<usuario-lista :usuarios="usuarios" @selecionou="selecionarUsuario($event)"/>
		<usuario-detalhe :usuarioSelecionado="objSelecionadoModel" />
	</div>
</template>
...
export default {
	...
	data() {
		return {
			...
			objSelecionadoModel: null,
		}
	},
	
	methods: {
		selecionarUsuario(objSelecionado){
			this.objSelecionadoModel = objSelecionado;
		}
	}
}
</script>
